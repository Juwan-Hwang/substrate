 ...
 *
 * This module is the single source of truth for the demo corpus; the
 * web app re-exports it from `@substrate/content` via `lib/articles.ts`
 * so there is exactly one place that owns article data.
 */
